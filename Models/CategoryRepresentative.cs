...
namespace IssueTrackerProject.Models
{
    ...
    public partial class CategoryRepresentative
    {
        ...
        [Display(Name = "CategoryRepresentative ID")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "CategoryRepresentative id is Required")]
        [MinLength(4, ErrorMessage = "Minimum 4 characters required")]
        public string CategoryRepresentativeId { get; set; }
